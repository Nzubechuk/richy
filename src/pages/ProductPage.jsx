  ...
  return (
    <div>
        ...
        <div className='flex justify-center mobile:flex-col mobile:mt-3 mobile:p-3'>
            ...
            <div className='flex flex-[1.3] items-start justify-item-start flex-col mt-10 mobile:items-center'>
                <h1 className='title text-[40px] mobile:text-[30px]'>Creamy Hoody 100% Original Cotton</h1>
                <p className='pr-[4rem] text-justify mt-4 mobile:pr-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus fugiat perferendis aliquid quae. Minus quis, eaque deserunt suscipit ullam cumque sit officiis modi vel! Vitae hic ipsa soluta facilis necessitatibus?</p>
