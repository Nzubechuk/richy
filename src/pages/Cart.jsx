                    ...
                    <div className='flex flex-col flex-1'>
                        <div className='flex w-[100%] h-auto items-center mobile:flex-col'>
                            <div className='product flex self-start pl-5'>
                                <img className='w-[7.2rem] h-[80%] rounded-lg shadow-lg hover:scale-[1.1] ease-in duration-300' src='https://cdn.shopify.com/s/files/1/0240/7285/products/WithinYourselfLongSleeveT-ShirtinElectricBlue04_360x.jpg?v=1642719824'  alt='product_img' />
                            </div>
                            <div className='description flex flex-col ml-5 h-auto justify-between'>
                                <p>
                                    <b className='mr-2'>ID:</b>12345676
                                </p>
                                <p>
                                ...
                                <p className='flex items-center justify-start'>
                                    ...
                                    <div className='rounded-full border-2 p-[10px] cuesor-pointer bg-sky-500 ml-1 w-[20px] h-[20px]'></div>
                                </p>
                                <p>
